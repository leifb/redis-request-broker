 ...
 *   namespace: A namespace that every redis key will use. Default is 'rrb'. In order
 *     to receiver requests, your clients need to use the same namespace.
 *   logger: Allows to inject a custom logger. It has to be a method that takes two
 *     arguments: The logging level and a message. You can configure the logging level
 *     strings using the levels option.
...
module.exports = class Worker {
    ...
    stop() {
        return new Promise((resolve, reject) => {
            ...
            this._log('STOP', '> Removing from availiblity set.');
